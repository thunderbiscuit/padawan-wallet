...
object Wallet {
    ...
    private var name: String = "Padawan Testnet 0"
    ...
    private var electrumURL: String = "tcp://testnet.aranguren.org:51001"
    ...
    fun createWallet(descriptor: String, changeDescriptor: String, editor: SharedPreferences.Editor): Unit {
        ...
        this.saveWallet(editor)
    }

    // save wallet parameters so that the wallet can be reloaded upon starting the app
    private fun saveWallet(editor: SharedPreferences.Editor): Unit {
