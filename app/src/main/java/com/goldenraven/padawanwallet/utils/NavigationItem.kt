...
sealed class NavigationItem(val route: String, val icon_filled: Int, val icon_outline: Int, val title: String) {
    ...
    object Tutorial : NavigationItem(route = Screen.TutorialsRootScreen.route, icon_filled = R.drawable.ic_hicon_education, icon_outline = R.drawable.ic_hicon_education, title = "Learn")
